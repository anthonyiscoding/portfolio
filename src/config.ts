export const siteConfig = {
  ...
  title: "Sales & Developer Relations",
  ...
  education: [
    {
      ...
      achievements: [
        ...
        "Staying current with latest developments in AI/ML through many hands-on projects.",
      ],
    },
    {
      ...
      achievements: [
        "Built multiple vibrant developer communities from scratch.",
        "Delivered technical presentations at conferences and meetups worldwide.",
        "Organized conferences, meetups, and all manner of events.",
        "Developed expertise in developer advocacy, community management, and technical communication.",
      ],
    },
    {
